...
//  { idProducto: 1, nombre: "yougur gloria", idCategoria: 1, descripcionCategoria:"Lacteos", stock: 30, precio: "2.5",imagen:"" },
  //{ idProducto: 2, nombre: "Detergente sapolio", idCategoria: 2, descripcionCategoria:"Productos de Limpieza", stock: 23, precio: "3.5" ,imagen:""},
  //{ idProducto: 3, nombre: "Mantequilla lavie", idCategoria: 3, descripcionCategoria:"Abarrotes", stock: 25, precio: "4.5" ,imagen:""},
...
export class ProductosComponent implements OnInit {
  ...
  getBase64Image(base64: string): SafeUrl {
