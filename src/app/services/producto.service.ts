...
export class ProductoService {
  ...
  savedos(formData: FormData): Observable<ResponseApi> {
    return this.http.post<ResponseApi>(`${this.apiBase}Guardar`, formData);
  }

  editdos(formData: FormData): Observable<ResponseApi> {
    return this.http.put<ResponseApi>(`${this.apiBase}Editar`, formData);
  }
